...
const PuzzlePage = (props) => {
  ...
  return(
    <div className="callout primary">
      <h1 className="headers">Here are some puzzles!</h1>
      <ul>
      ...
      <h1 className="headers">Randomly Generated Puzzles from Sugoku!</h1> 
      <h5 className="disclaimer">Note: Due to the inconsistency of the API, know that some of these puzzles might not actually be completeable.</h5>
      <ul>
