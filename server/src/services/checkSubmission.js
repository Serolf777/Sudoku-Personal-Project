class checkSubmission {
  ...
  checkColumn() {
    ...
    for(let x = 0; x< 7; x+3){
      column1.push(this.sudokuPuzzle.box1[i])
      column2.push(this.sudokuPuzzle.box1[i+1])
      column3.push(this.sudokuPuzzle.box1[i+2])
      column4.push(this.sudokuPuzzle.box2[i])
      column5.push(this.sudokuPuzzle.box2[i+1])
      column6.push(this.sudokuPuzzle.box2[i+2])
      column7.push(this.sudokuPuzzle.box3[i])
      column8.push(this.sudokuPuzzle.box3[i+1])
      column9.push(this.sudokuPuzzle.box3[i+2])
    }

    for(let x= 0; x< 7; x+3){
      column1.push(this.sudokuPuzzle.box4[i])
      column2.push(this.sudokuPuzzle.box4[i+1])
      column3.push(this.sudokuPuzzle.box4[i+2])
      column4.push(this.sudokuPuzzle.box5[i])
      column5.push(this.sudokuPuzzle.box5[i+1])
      column6.push(this.sudokuPuzzle.box5[i+2])
      column7.push(this.sudokuPuzzle.box6[i])
      column8.push(this.sudokuPuzzle.box6[i+1])
      column9.push(this.sudokuPuzzle.box6[i+2])
    }

    for(let x= 0; x< 7; x+3){
      column1.push(this.sudokuPuzzle.box7[i])
      column2.push(this.sudokuPuzzle.box7[i+1])
      column3.push(this.sudokuPuzzle.box7[i+2])
      column4.push(this.sudokuPuzzle.box8[i])
      column5.push(this.sudokuPuzzle.box8[i+1])
      column6.push(this.sudokuPuzzle.box8[i+2])
      column7.push(this.sudokuPuzzle.box9[i])
      column8.push(this.sudokuPuzzle.box9[i+1])
      column9.push(this.sudokuPuzzle.box9[i+2])
    }
  ...
  get isCorrect() {
    if(this.checkBox() && this.checkColumn() && this.checkRow() ){
      return true
    }
    else{
      return false
